...
This is a simple yet quite nice and cozy "Chat - app", linked with "Firebase", enabling users to Sign Up/Sign In, upload a photo, and of course, send messages and photos to each other. While sending and receiving messages from registered users the "new" badge (indicating unread messages) on the appropriate user is shown.

## Project status

Features that are planned to develop in the future:

- Group Chat/Search (within a conversation and among users)
- Edit Profile (user name, email, etc.)
